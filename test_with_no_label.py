...
#         'outputs/esrt_gan/esrt_lsgan(l1)_(l1)_ph2/checkpoints/patch/patch-200/factor_2/epoch_1050_f_2.pth',
#     ]
    
# names =  ['ph1_l1_ssim','ph2_standard','ph3_standard','ph2_lstandard', 'ph3_lsgan', 'ph2_lsgan', 'ph1_l1', 'ph2_standard_debug', 'ph2_standard_default', 'ph2_lsgan']

checkpoints = [
    # 'outputs/esrt/esrt_l1_ph1/checkpoints/patch/patch-200/factor_2/epoch_3500_f_2.pth',
    # 'outputs/esrt/esrt_l1_ssim_ph1/checkpoints/patch/patch-200/factor_2/epoch_3500_f_2.pth',
    # 'outputs/esrt_gan/esrt_standardgan(l1)_(l1)_ph2/checkpoints/patch/patch-200/factor_2/epoch_3500_f_2.pth',
    # 'outputs/esrt_gan/esrt_lsgan(l1)_(l1)_ph2/checkpoints/patch/patch-200/factor_2/epoch_1050_f_2.pth',
    # 'outputs/esrt_gan/esrt_standard_gan(adv)_standard(l1)_ph3/checkpoints/patch/patch-200/factor_2/epoch_2500_f_2.pth',
    'outputs/esrt_gan/esrt_gan_lsgan(adv(_lsgan(l1)_ph3/checkpoints/patch/patch-200/factor_2/epoch_1200_f_2.pth'
]
names = ['ph3_l1_lsgan']
...
parser.add_argument("--test_lr_folder", type=str, default='../model_bias_experiment/mri_dataset_50/test_small',
...
# opt.checkpoint = 'outputs/esrt_gan/esrt_standardgan(l1)_(l1)_ph2/checkpoints/patch/patch-200/factor_2/epoch_3500_f_2.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_lsgan(l1)_(l1)_ph2/checkpoints/patch/patch-200/factor_2/epoch_1050_f_2.pth'
# opt.checkpoint= 'outputs/esrt_gan/esrt_gan_lsgan(adv(_lsgan(l1)_ph3/checkpoints/patch/patch-200/factor_2/epoch_1200_f_2.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_standard_gan(adv)_standard(l1)_ph3/checkpoints/patch/patch-200/factor_2/epoch_1050_f_2.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_standard_gan(adv)_standard(l1)_ranker_loss_ph3/checkpoints/patch/patch-200/factor_2/epoch_2050_f_2.pth'

# opt.checkpoint = 'outputs/esrt_gan/esrt_standardgan(adv)_ph1/checkpoints/patch/patch-200/factor_2/epoch_400_f_2.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_standard_gan(adv)_ph1_25_50_micron/checkpoints/patch/patch-200/factor_2/epoch_2050_f_2.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_factor_1_standard_gan(adv)_chckpoint(ph1,l1)_25_50_micron/checkpoints/patch/patch-120/factor_1/epoch_550_f_1.pth'
# opt.checkpoint =   'outputs/esrt_gan/esrt_factor_1_standard_gan(adv)_chckpoint(ph1,l1)_mixed_dataset/checkpoints/patch/patch-120/factor_1/epoch_950_f_1.pth'
# opt.checkpoint = 'outputs/esrt/esrt_factor_1_l1_ph1/checkpoints/patch/patch-120/factor_1/epoch_1200_f_1.pth'

# opt.checkpoint = 'outputs/esrt/esrt_factor_1_l1_ph1_raw_array_train/checkpoints/patch/patch-120/factor_1/epoch_1200_f_1.pth'
# opt.checkpoint = 'outputs/esrt_gan/esrt_factor_1_standard_gan(adv)_chckpoint(ph1,l1)_25_50_micron_array_data/checkpoints/patch/patch-120/factor_1/epoch_50_f_1.pth'
opt.checkpoint = 'outputs/esrt_gan/esrt_factor_1_standard_gan(adv)_chckpoint(ph1,l1)_mixed_dataset/checkpoints/patch/patch-120/factor_1/epoch_900_f_1.pth'
print("Using checkpoint", opt.checkpoint)
# name = 'standard_l1_ph1'

# opt.output_folder = 'results/'+ str(names[opt.idx])
# opt.output_folder = 'results/'+ 'standard_(adv_only)_simulated'
# opt.output_folder = 'results/'+ 'standard_(adv_only)_real'
# opt.output_folder = 'results/'+ 'standard_real_same_size_ph2'
# opt.output_folder = 'results/'+ 'standard_mixed_ph23_factor1'
# opt.output_folder = 'results/'+ 'l1_ph1_factor1'

# opt.output_folder = 'results/'+ 'l1_ph1_factor1_raw_data'
# opt.output_folder = 'results/'+ 'standard_real_raw_inp'
opt.output_folder = 'results/'+ 'standard_mixed_raw_inp'
...
def forward_chop(model, x, shave=10, min_size=60000, scale=1):
...
for imname in filelist:
    ...
    print("before shape", im_lr.shape)

    x, y = im_lr.shape
    im_lr = cv2.resize(im_lr,(2*y,2*x),  interpolation=cv2.INTER_CUBIC)
    print(im_lr.shape)
    ...
    print ("Reached here")
    with torch.no_grad():
        out = forward_chop(model= model,x= im_input, scale = 1) #model(im_input)
...
#     im_pred = lr_image.resize(shape,Image.BICUBIC)
